...
## Profile
- Solid academic training in **advanced mathematics, probability, and statistics**, directly applicable to data-driven decision making.
- Experienced with **Python (pandas, matplotlib, seaborn), SQL, Excel**, and basic knowledge of **Power BI**.
...
- Attention to detail and methodological approach when analyzing data.
